    ...
    <Card className="p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-border/70 bg-card/60 p-4">
          ...
          {checksumStatus && (
            <p className="mt-2 text-xs text-muted-foreground">Checksum • {checksumStatus}</p>
          )}
        </div>
        ...
        {payloadPreview && (
          <div className="grid gap-3 rounded-xl border border-border/70 bg-muted/20 p-3 text-xs">
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-foreground">v{payloadPreview.packet.version}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Binary length</span>
              <span className="font-mono text-foreground">{payloadPreview.binary.length} bits</span>
            </div>
            <div className="flex items-center justify-between">
